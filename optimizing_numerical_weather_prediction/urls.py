"""optimizing_numerical_weather_prediction URL Configuration
...
from optimizing_numerical_weather_prediction import settings
...
urlpatterns = [
    ...
    url(r'^Prediction_Of_Weather_Type/$', remoteuser.Prediction_Of_Weather_Type, name="Prediction_Of_Weather_Type"),
    ...
    url(r'^View_Prediction_Of_Weather_Type_Ratio/$', serviceprovider.View_Prediction_Of_Weather_Type_Ratio, name="View_Prediction_Of_Weather_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Weather_Type/$', serviceprovider.View_Prediction_Of_Weather_Type, name="View_Prediction_Of_Weather_Type"),
