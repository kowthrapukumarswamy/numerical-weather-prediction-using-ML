...
ROOT_URLCONF = 'optimizing_numerical_weather_prediction.urls'
...
WSGI_APPLICATION = 'optimizing_numerical_weather_prediction.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'optimizing_numerical_weather_prediction',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
